...
This is the webpage for [MAST30026: Metric and Hilbert spaces](https://handbook.unimelb.edu.au/subjects/mast30026). The complete course notes, assignments and solutions for previous years are available below, and the 2018 recordings are [on YouTube](https://www.youtube.com/playlist?list=PLKnx70LRf21eSXaawNhiCCPrzsbLdT5do). The next time the subject will be offered is Semester 2 of 2020, but I run **free public office hours** every week Tuesdays 10-11am Melbourne time ([Zoom meeting link](https://unimelb.zoom.us/j/98396495333)) and there is a public [Discord](https://discord.gg/nV3E4C) where you can join other people studying the material.

There will be three assignments due at regular intervals during semester amounting to a total of 20%, and a 3-hour written examination in the examination period worth 80%. Office hours will be Wednesdays 2-3pm, Thursdays 2-3pm and Fridays 11am-12pm in Room 168.

Note that you may need to manually change the quality setting on YouTube to HD in order to be able to read the board.

**2019 edition:** from Lecture 4 you can ignore everything except for Lemma L4-1 and Exercise L4-0. We will skip Lecture 5 entirely. The proof of Theorem L11-4 (finite CW-complexes are Hausdorff) will be skipped. The Bellman equation (part of Lecture 15) will not be covered in lectures. Theorem L12-7 will be skipped. These cuts are to make time for material on operators on Hilbert space and quantum mechanics at the end of semester. The projected schedule is indicated in {-} brackets.
...
In every lecture there will be assigned exercises and the three graded assignments will be largely made up of questions from those exercises. Ergo, keep up with the exercises and you'll be in good shape for the assessment. Assignments are to be submitted to Box 188.
