...
* Lecture 12: Function spaces ([notes](http://therisingsea.org/notes/mast30026/lecture12.pdf) | [video1](https://youtu.be/twSGGyc0G_E) | [video2](https://youtu.be/hLlPa_NdcBg) | [video3](https://youtu.be/90kaC4aUQ_U))
* Lecture 13: Metrics on function spaces ([notes](http://therisingsea.org/notes/mast30026/lecture13.pdf))
...
* Lecture 1: What is space? (*SO(2) acting on R2*)
* Lecture 2: Examples of spaces (*metric space*, *arc length metric on S1*)
* Lecture 3: Isometries (*isometries*, *classification of isometries of S1*, *orientation*)
* Lecture 4: Metrics from matrices (*Rn as metric space*, *metrics from positive-definite matrices*)
* Lecture 5: Minkowski space and special relativity (*postules of SR, derivation of Lorentz group*, *Minkowski space*)
* Lecture 6: Topological spaces (*topological spaces*, *continuous maps*, *Sierpinski space*, *topology associated to a metric*, *abstract continuity matches with epsilon-delta continuity*)
* Lecture 7: Constructing topological spaces (*bases*, *product spaces*, *quotient spaces*, *disjoint unions*, *homeomorphisms*, *pushouts*, *torus*, *Mobius strip*, *graph as a topological space*, *finite CW complexes*, *projective space*)
* Lecture 8: Compactness I (*closed and bounded sets*, *Bolzano-Weierstrass*, *continuity as preservation of limits*, *sequential compactness in metric spaces*)
* Lecture 9: Compactness II (*cover compactness*, *sequential compactness equals compactness for metric spaces*, *extreme value theorem for compact spaces*)
* Lecture 10: Compactness III (*preservation of compactness under quotients and finite products*, *Heine-Borel*, *finite CW complexes are compact*)
* Lecture 11: Hausdorff spaces (*metrisable spaces are Hausdorff*, *products of Hausdorff spaces are Hausdorff*, *real line with double point*, *compact subspaces of Hausdorff spaces are closed*, *continuous bijections from compact to Hausdorff spaces are homeomorphisms*, *finite CW complexes are Hausdorff*, *normal and regular spaces*)
* Lecture 12: Function spaces (*function space as configuration space*, *compact-open topology*, *evaluation and composition are continuous*, *path space, loop space*, *space of of graphs*)
* Lecture 13: Metrics on function spaces (*for X compact and Y metrisable, the compact-open topology on Cts(X,Y) is metrisable*)