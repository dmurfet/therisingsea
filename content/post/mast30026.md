...
* Lecture 7: Constructing topological spaces ([lecture notes](http://therisingsea.org/notes/mast30026/lecture7.pdf) | [video1](https://youtu.be/WmSxAsUEOuo))

Rough future schedule:

* Week 5: Compactness
* Week 6: Completeness (including the fixed point theorem)
* Week 7: Urysohn's lemma and metrisation I
* Week 8: Urysohn's lemma and metrisation II
* Week 9: Tychonoff's theorem and Stone-Cech compactification
* Weeks 10-12: Hilbert and Banach spaces

The aim is to have proven the following theorems by the end of the semester:
...
* [Urysohn's metrisation theorem](https://en.wikipedia.org/wiki/Metrization_theorem)
...
* If we have time, I would like to prove the [Stone-Weierstrass theorem](https://en.wikipedia.org/wiki/Stone%E2%80%93Weierstrass_theorem), but we'll see how we go.
