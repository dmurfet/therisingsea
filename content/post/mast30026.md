...
* Lecture 7: Constructing topological spaces ([lecture notes](http://therisingsea.org/notes/mast30026/lecture7.pdf) *updated 13-8* | [video1](https://youtu.be/WmSxAsUEOuo))
* Lecture 8: Compact spaces ([lecture notes](http://therisingsea.org/notes/mast30026/lecture8.pdf))
...
The aim is to have proven the following list of theorems by the end of the semester. This is likely to be a bit too ambitious:
