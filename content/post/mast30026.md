...
* Lecture 12: Function spaces ([notes](http://therisingsea.org/notes/mast30026/lecture12.pdf) *updated 14-10* | [video1](https://youtu.be/twSGGyc0G_E) | [video2](https://youtu.be/hLlPa_NdcBg) | [video3](https://youtu.be/90kaC4aUQ_U) | [video4](https://youtu.be/N1shTZiP_pA))
...
* Lecture 18: Banach space ([notes](http://therisingsea.org/notes/mast30026/lecture18.pdf) *updated 14-10* | [video1](https://youtu.be/YzSHub6Pmjc) | [video2](https://youtu.be/AkakypK_Les) | [video3](https://youtu.be/ygw2JrOjyRc))
...
* Lecture 20: Hilbert space ([notes](http://therisingsea.org/notes/mast30026/lecture20.pdf) *updated 14-10* | [video1](https://youtu.be/ZrrTwqrCvzk))
* Lecture 21: Coordinates in Hilbert space ([notes](http://therisingsea.org/notes/mast30026/lecture21.pdf))
* Lecture 22: What is space? Quantum edition

My aim is to prove the following theorems by the end of the semester. As you may have noticed, this is an evolving list. The current intention is that the theorems marked *extension* will be posted as lecture notes, and perhaps even lectured outside of class time, but on a completely optional basis (i.e. not for assessment):

* [Adjunction property for function spaces](https://bit.ly/2EbLAtV) (*done*)
* [Banach fixed point theorem](https://en.wikipedia.org/wiki/Banach_fixed-point_theorem) (*done*)
* [Picard theorem](https://en.wikipedia.org/wiki/Picard%E2%80%93Lindel%C3%B6f_theorem) (*done*)
* [Stone-Weierstrass theorem](https://en.wikipedia.org/wiki/Stone%E2%80%93Weierstrass_theorem) (*done*)
* [Riesz representation theorem](https://en.wikipedia.org/wiki/Riesz_representation_theorem)
* [Spectral theorem](https://en.wikipedia.org/wiki/Spectral_theorem) (*extension*)
...
* **Lecture 13**: for X compact and Y metrisable the compact-open topology on Cts(X,Y) is metrisable, closure, interior, density, pointwise and uniform convergence, continuity of uniform limits of continuous functions, complete metric spaces, completeness of Cts(X,Y) for X compact and Y a complete metric space.
...
* **Lecture 16**: Weierstrass approximation theorem, Stone-Weierstrass theorem, algebras of functions, topological algebras, Bernstein polynomials, trigonometric polynomials are dense, *one-point compactification*.
