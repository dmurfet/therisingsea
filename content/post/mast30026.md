...
* Lecture 7: Constructing topological spaces ([lecture notes](http://therisingsea.org/notes/mast30026/lecture7.pdf) *updated 21-8* | [video1](https://youtu.be/WmSxAsUEOuo) | [video2](https://youtu.be/7kMfUi7MHbM) | [video3](https://youtu.be/IU6MhgYi8xE))
...
* Lecture 9: Compactness II ([lecture notes](http://therisingsea.org/notes/mast30026/lecture9.pdf) *updated 22-8* | [video1](https://youtu.be/ZtNeeMgfcGU) | [video2](https://youtu.be/1_nDG6u8fxI))
* Lecture 10: Compactness III ([lecture notes](http://therisingsea.org/notes/mast30026/lecture10.pdf) *updated 22-8* | [video](https://youtu.be/6aEQ4KCugq4))
* Lecture 11: Hausdorff spaces ([lecture notes](http://therisingsea.org/notes/mast30026/lecture11.pdf) *updated 24-8* | [video](https://youtu.be/jS2YY3WbKLo))

Rough future schedule:

* Week 6: Function spaces, Banach fixed point theorem
* Week 7: Picard-Lindelof theorem, beginning of Banach spaces
* Weeks 8-11: Banach and Hilbert spaces
* Week 12: Spectral theorem

If there's time we'll try to do Urysohn's lemma, Tychonoff's theorem and Stone-Cech compactification, but I'm not sure yet. My aim is to prove the following theorems by the end of the semester:
...
* [Urysohn's lemma](https://en.wikipedia.org/wiki/Urysohn%27s_lemma) (maybe not)
* [Tychonoff's theorem](https://en.wikipedia.org/wiki/Tychonoff%27s_theorem) (maybe)
* [Stone-Cech compactification](https://en.wikipedia.org/wiki/Stone%E2%80%93%C4%8Cech_compactification) (maybe)
...
**Assignment 2** due by 4pm on 7-9 (Week 6):
