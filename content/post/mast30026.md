...
**2019 edition:** we will only cover Lecture 4 up to the end of p.2, and we will skip Lecture 5 entirely. The proof of Theorem L11-4 (finite CW-complexes are Hausdorff) will be covered by tutorials, and the Bellman equation (part of Lecture 15) will also not be covered in lectures. These cuts are to make time for material on operators on Hilbert space, the spectral theorem, quantum mechanics and harmonic functions at the end of semester.
